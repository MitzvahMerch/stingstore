...
const DCDCBlackSweatpantsPage = () => {
  ...
  const addToCart = () => {
    ...
    const newItem: CartItem = {
      productId: 'dcdc-black-sweatpants',
      productName: 'DCDC Black Sweatpants',
      price: 34.99,
      sizes: selectedSizes,
          ...
          <CardContent className="flex gap-8">
            ...
            <div className="w-1/3">
              <div className="space-y-6">
                <h1 className="text-2xl font-bold text-black">DCDC Black Sweatpants</h1>
...
export default DCDCBlackSweatpantsPage;