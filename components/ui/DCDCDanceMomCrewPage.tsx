...
const DCDCDanceMomCrewPage = () => {
  ...
  const addToCart = () => {
    ...
    const newItem: CartItem = {
      productId: 'dcdc-dance-mom-crew',
      productName: 'DCDC Dance Mom Crew',
      price: 34.99,
      sizes: selectedSizes,
          ...
          <CardContent className="flex gap-8">
            <div className="w-2/3">
              <div className="relative h-[400px] border-2 border-black">
                <Image
                  src="/images/DanceMomCrew.png"
                  alt="DCDC Dance Mom Crew"
                  fill
                  className="object-contain"
                  priority
                />
            ...
            <div className="w-1/3">
              <div className="space-y-6">
                <h1 className="text-2xl font-bold text-black">DCDC Dance Mom Crew</h1>
...
export default DCDCDanceMomCrewPage;